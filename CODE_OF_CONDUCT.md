## Code of Conduct for Contributing to Django Dynamic Form

we’re thrilled that you want to contribute to `dj-dynamic-form`! to ensure a positive and protective environment for everyone involved, please adhere to the following guidelines.

## Contribution Workflow

1. **Fork and Clone**: Start by forking the `dj-dynamic-form` repository on Github and cloning it to your local machine:
    ```bash
    git clone https://github.com/lazarus-org/dj-dynamic-form.git
    cd dj-dynamic-form
    ```
...
Thank you for contributing to `dj-dynamic-form`! We look forward to your contributions.
