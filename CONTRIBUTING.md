# Contributing to Django Dynamic Form


We’re excited that you’re interested in contributing to `dj-dynamic-form`! Whether you’re fixing a bug, adding a feature, or improving the project, your help is appreciated.
...
1. **Fork the Repository:**
   ...
   Begin by forking the `dj-dynamic-form` repository on GitHub. This creates your own copy where you can make changes.
...
2. **Clone Your Fork:**
   ...
   ```bash
   git clone https://github.com/your-username/dj-dynamic-form.git
   cd dj-dynamic-form
   ```
...
For linting, `pylint` is used to enforce style and catch potential errors:
   ...
   ```bash
   poetry run pylint dynamic_form
   ```
...
3. **Open a Pull Request:**
   ...
   Go to the original `dj-dynamic-form` repository and open a pull request. Include a detailed description of your changes and link any related issues.
...
1. **Open an Issue:**
   ...
   Head over to the `Issues` section of the `dj-dynamic-form` repository and click "New Issue".
...
Thank you for your interest in contributing to `dj-dynamic-form`! We look forward to your contributions.
